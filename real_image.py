...
if __name__ == '__main__':
    ...
    for page in pages:
        ...
        string = pytesseract.image_to_string(Image.open('tmp2.jpg'), lang='chi_tra')
        with open(txt_root + "tmp2.txt", "w", encoding='utf-8') as W:
        ...
        for p in page[1]:
            context_all += p
        with open(txt_root + "tmp2.txt", "r", encoding='utf-8') as R:
            for line in R:
                string = []
                string = line.split('\n')[0]
